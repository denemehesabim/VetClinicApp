...
public class OwnerRepositoryImpl implements OwnerRepository {
    ...
    public boolean existEmail(String email) {
        Query query = entityManager.createQuery("select o from Owner o where o.mail = : email");
    ...
    public List<Owner> findOwnersByOwnerName(String ownerName) {
       return entityManager.createQuery("from Owner o where lower(o.name) like :ownerName").setParameter("ownerName", ownerName.toLowerCase() + '%').getResultList();
    }
